  ...
  <div class="px-4 py-6">
    ...
    <header class="flex items-center gap-4 mb-6">
      ...
      <div>
        ...
        <p class="text-gray-500 text-sm">Track your income or expense</p>
      </div>
    </header>
    ...
    <form @submit.prevent="submitTransaction" class="space-y-6">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-soft">
        ...
        <div class="flex items-center gap-2">
          ...
          <input
            ...
            required
            min="1"
            class="flex-1 text-3xl font-bold text-gray-900 bg-transparent outline-none"
          />
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-4 shadow-soft">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            ...
            class="flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-medium transition-all"
            :class="form.type === 'income' 
              ? 'bg-green-500 text-white shadow-lg shadow-green-500/30' 
              : 'bg-gray-100 text-gray-600'"
          >
            <PhArrowDown :size="20" weight="bold" />
            Income
          </button>
          <button
            type="button"
      ...
      <div class="bg-white rounded-2xl p-4 shadow-soft">
        ...
        <div v-if="filteredCategories && filteredCategories.length > 0" class="grid grid-cols-4 gap-3">
          <button
        ...
        <div v-else class="grid grid-cols-4 gap-3">
          <div v-for="i in 8" :key="i" class="h-20 bg-gray-100 rounded-xl animate-pulse" />
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl p-4 shadow-soft">
        ...
        <input
          ...
          class="w-full px-4 py-3 bg-gray-50 rounded-xl outline-none focus:ring-2 focus:ring-primary-500/20 transition-all"
        />
      </div>
      ...
      <button
        ...
        class="w-full py-4 bg-primary-500 text-white rounded-2xl font-bold text-lg shadow-lg shadow-primary-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-[0.98]"
      >
