<template>
  <div class="min-h-screen bg-gradient-to-br from-primary-500 via-primary-600 to-orange-700 flex flex-col">
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 pt-12 pb-8">
      ...
      <p class="text-primary-100 text-center">Sign in to continue tracking your finances</p>
    </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <div class="text-center">
          <p class="text-gray-600">
            ...
            <NuxtLink to="/register" class="text-primary-500 font-semibold ml-1">
              Sign Up
            </NuxtLink>
          </p>
        </div>
...
import { PhWallet, PhEnvelope, PhLock, PhEye, PhEyeSlash, PhSpinner } from '@phosphor-icons/vue'
